  ...
  return (
    <>
      <Environment background>
        ...
        <Lightformer form="circle" intensity={5} position={[0, 0, 5]} />
        <Lightformer form="circle" intensity={15} position={[5, 0, 0]} rotation={[0, Math.PI / 2, 0]} />
        <Lightformer form="circle" intensity={5} position={[-5, 0, 0]} rotation={[0, Math.PI / 2, 0]} />
        <Lightformer form="circle" intensity={5} position={[0, 5, 0]} rotation={[Math.PI / 2, 0, 0]} />
      </Environment>
    </>
  );
};
